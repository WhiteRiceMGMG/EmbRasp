...
#define	GPIO_CTRL(n)            (IO_BANK0_BASE+0x04+(n*8))  /*GPIOピンn番目の制御用レジスタのアドレス*/
    
#define	GPIO_CTRL_FUNCSEL_I2C   3                           /*GPIOをI2C機能として使うときに指定する．*/
#define	GPIO_CTRL_FUNCSEL_NULL  31                          /*GPIO機器を無しにする番号*/
