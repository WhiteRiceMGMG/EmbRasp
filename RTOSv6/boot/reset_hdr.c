...
static void init_peri(void)
{
    ...
    /* 端子設定 */
    out_w(GPIO_OE_CLR, (1<<15));    /* P25端子出力無効 */
    out_w(GPIO_OUT_CLR, (1<<15));   /* P25端子出力クリア */
    out_w(GPIO_CTRL(15), 5);        /* P25端子 SIO */
    out_w(GPIO_OE_SET, (1<<15));    /* P25出力有効 */

    out_w(GPIO_OE_CLR, (1<<13));    /* P25端子出力無効 */
    out_w(GPIO_OUT_CLR, (1<<13));   /* P25端子出力クリア */
    out_w(GPIO_CTRL(13), 5);        /* P25端子 SIO */
    out_w(GPIO_OE_SET, (1<<13));    /* P25出力有効 */

    out_w(GPIO_OE_CLR, (1<<11));    /* P25端子出力無効 */
    out_w(GPIO_OUT_CLR, (1<<11));   /* P25端子出力クリア */
    out_w(GPIO_CTRL(11), 5);        /* P25端子 SIO */
    out_w(GPIO_OE_SET, (1<<11));    /* P25出力有効 */

    out_w(GPIO_OE_CLR, (1<<9));    /* P25端子出力無効 */
    out_w(GPIO_OUT_CLR, (1<<9));   /* P25端子出力クリア */
    out_w(GPIO_CTRL(9), 5);        /* P25端子 SIO */
    out_w(GPIO_OE_SET, (1<<9));    /* P25出力有効 */



    out_w(GPIO_CTRL(18), 5);          // SIO機能に設定
    out_w(GPIO_OE_CLR, (1 << 18));    // 出力無効 → 入力モード

    out_w(GPIO_CTRL(20), 5);          // SIO機能に設定
    out_w(GPIO_OE_CLR, (1 << 20));    // 出力無効 → 入力モード

    out_w(GPIO_CTRL(16), 5);          // SIO機能に設定
    out_w(GPIO_OE_CLR, (1 << 16));    // 出力無効 → 入力モード

    out_w(GPIO_CTRL(22), 5);          // SIO機能に設定
    out_w(GPIO_OE_CLR, (1 << 22));    // 出力無効 → 入力モード
